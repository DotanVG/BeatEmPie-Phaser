...
Claude Code discovers the project skill at `.claude/skills/graphify/SKILL.md`.
The lightweight `SessionStart` hook only announces an existing graph; it never
builds or updates one. Intentional commands are documented in that skill and in
the README.
